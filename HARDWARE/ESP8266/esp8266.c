...
//	char cStr [ 100 ] = { 0 };
  printf ( "\r\n now Config ESP8266 ......\r\n" );
	...
	printf ( "\r\n macESP8266_CH_ENABLE Over ......\r\n" );
	
	ESP8266_AT_Test ();
	printf ( "\r\n ESP8266_AT Test Over......\r\n" );
	
	
	ESP8266_Net_Mode_Choose ( STA_AP );   // 这里必须使用这种模式，前两种模式不可行
	printf ( "\r\n ESP8266_Net_Mode_Choose over ......\r\n" );
	delay_s(5);
	...
	printf ( "\r\n Connect WiFi ......\r\n" );
  ESP8266_Cmd ( "AT+CWJAP=\"DESKTOPTI\",\"qiao5555\"", "OK", 0, 1000 );
	delay_s(10);
	...
	printf ( "\r\n Connect TCP ......\r\n" );
	ESP8266_Cmd("AT+CIPSTART=\"TCP\",\"101.76.211.1\",8080","OK",0,1000);
	//delay_s(10);
