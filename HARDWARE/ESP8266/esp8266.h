...
/********************************** 用户需要设置的参数**********************************/
#define      macUser_ESP8266_ApSsid                       "DESKTOP3080TIWIFI"                //要连接的热点的名称
#define      macUser_ESP8266_ApPwd                        "qiao5555"           //要连接的热点的密钥

//#define      macUser_ESP8266_TcpServer_IP                 "101.76.211.1"      //要连接的服务器的 IP
